...
def main(argv):
    ...
    idx2entity_path = 'data/music_idx2entity.pkl'

    train_lhs_path = 'data/music-train-lhs.pkl'
    train_rel_path = 'data/music-train-rel.pkl'
    train_rhs_path = 'data/music-train-rhs.pkl'

    valid_lhs_path = 'data/music-valid-lhs.pkl'
    valid_rel_path = 'data/music-valid-rel.pkl'
    valid_rhs_path = 'data/music-valid-rhs.pkl'

    test_lhs_path = 'data/music-test-lhs.pkl'
    test_rel_path = 'data/music-test-rel.pkl'
    test_rhs_path = 'data/music-test-rhs.pkl'

    train_f = open('music-train.pkl', 'wb')
    train = merge(idx2entity_path, train_lhs_path, train_rel_path, train_rhs_path)
    pickle.dump(train, train_f)
    train_f.close()

    valid_f = open('music-valid.pkl', 'wb')
