...
# def adagrad(param, rate, epsilon, gradient, updates, param_squared_gradients):
cmd_adagrad = ('./learn_parameters.py --seed=%d --strategy=%s --totepochs=%d --test_all=%d --lr=%f --name=fb15k_regularization/fb15k_%s_%d '
                ...
                ' > logs/fb15k_models_regularization/fb15k_regularization.%s_%s_%d_%d_%d_%s_%s_%d.log 2>&1')
