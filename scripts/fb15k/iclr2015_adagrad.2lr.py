...
cmd = './learn_parameters.py --op=%s --sim=%s --strategy=%s --totepochs=%d --test_all=100 --lremb=%f --lrparam=%f --ndim=%d --nhid=%d --name=fb15k_adagrad.2lr_%d  --train=%s --valid=%s --test=%s --nbatches=%d > logs/fb15k.adagrad.2lr_%d.log 2>&1'
